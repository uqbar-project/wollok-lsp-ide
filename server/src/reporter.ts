...
const validationMessagesEn: ValidationMessage = {
  ...
  'shouldMatchSuperclassReturnValue' : 'Superclass method returned value does not match current definition',
...
const validationMessagesEs: ValidationMessage = {
  ...
  'shouldMatchSuperclassReturnValue' : 'El valor del tipo devuelto no coincide con el m\u00E9todo definido en la superclase',

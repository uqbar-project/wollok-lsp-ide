...
const validationMessagesEn: ValidationMessage = {
  ...
  'shouldPassValuesToAllAttributes' : 'Reference {0} not found in {1}', //yo
  ...
  'shouldMatchSuperclassReturnValue' : 'HELP!',
...
const validationMessagesEs: ValidationMessage = {
  ...
  'shouldMatchSuperclassReturnValue' : 'HELPDebe retornar un valor ya que el m\u00E9todo sobrescrito retorna un valor',
  ...
  'shouldNotDuplicateFields' : 'Ya existe un ¿colaborador interno? ¿campo? con este nombre en la jerarqu\u00EDa',
